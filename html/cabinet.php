    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
          <?php
    				...
    				$SPECIALITE="";
    				$DATEAJOUT="";
    				$req="select * from cabinet order by id desc";
                ...
                <div class="card">
                    <div class="body">
                        <div class="member-card verified">
                          ...
                          <p class="text-muted"><?php echo $SPECIALITE; ?></p>

                            <div class="">
                                <h4 class="m-b-5 m-t-20"><?php echo $TEL; ?></h4>
                                <h4 class="m-b-5 m-t-20"><?php echo $ADRESSE; ?></h4>
                            </div>

                            <a href=""  class="btn btn-raised btn-sm">Voir cabinet</a>
            ...
            if ($num==0) {
              ?>
              <h4 style="color: #3CB371;">Aucun cabinet Enregistrer. </h4>
              <?php
            }
      			?>
        </div>
        <div class="row clearfix">
            <div class="col-sm-12 text-center">
                <a href="add-cabinet.php" class="btn btn-raised g-bg-cyan">Ajoute cabinet</a>
            </div>
        </div>
    </div>
</section>
