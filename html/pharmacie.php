    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
          <?php
            ...
            $WEBSITE="";
    				$DATEAJOUT="";
    				$req="select * from pharmacie order by id desc";
    				$query=mysqli_query($connect, $req);
    				while($enreg=mysqli_fetch_array($query)){
    					$NOMPHARMACIE	=	$enreg['NOMPHARMACIE'];
    					$TEL		=	$enreg['TEL'];
    					$EMAIL		=	$enreg['EMAIL'];
                    ...
                    <div class="body">
                        <div class="member-card verified">
                          <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $NOMPHARMACIE; ?></h3>
                          </div>
        ...
        <div class="row clearfix">
            <div class="col-sm-12 text-center">
                <a href="add-pharmacie.php" class="btn btn-raised g-bg-cyan">Ajoute Pharmacie</a>
            </div>
        </div>
    </div>
</section>
