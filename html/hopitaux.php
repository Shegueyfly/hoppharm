    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
          <?php
                    ...
                    <div class="body">
                        <div class="member-card verified">
                          <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $NOMHOPITAL; ?></h3>
                          </div>

                            <div class="">
                                <h4 class="m-b-5 m-t-20"><?php echo $TEL; ?></h4>
                                <h4 class="m-b-5 m-t-20"><?php echo $EMAIL; ?></h4>
                                <p class="text-muted"><span> <a href="#" class="text-pink"><?php echo $WEBSITE; ?></a> </span><?php echo $DESCRIPTION; ?></p>
                            </div>

                            <p class="text-muted"><?php echo $LOCALISATION; ?></p>
                            <a href="profile.php"  class="btn btn-raised btn-sm">Voir hopital</a>
            ...
            if ($enreg==NULL) {
              ?>
              <h4 style="color: #3CB371;">Aucun hopital Enregistrer. </h4>
              <?php
            }
      			?>
        </div>
        <div class="row clearfix">
            <div class="col-sm-12 text-center">
                <a href="add-hopital.php" class="btn btn-raised g-bg-cyan">Ajoute hopital</a>
            </div>
        </div>
    </div>
</section>
