                    ...
                    <div class="body">
                        <div class="member-card verified">
                          <div class="box-header with-border">
                            <h3 class="box-title"><?php echo $NOMPRENOM; ?></h3>
                          </div>

                            <div class="">
                                <h4 class="m-b-5 m-t-20"><?php echo $TEL; ?></h4>
                                <p class="text-muted"><span> <a href="#" class="text-pink"><?php echo $EMAIL; ?></a> </span><?php echo $SUJET; ?></p>
                            </div>

                            <p class="text-muted"><?php echo $MESSAGE; ?></p>
                            <a href="profile.php"  class="btn btn-raised btn-sm">View contact</a>
