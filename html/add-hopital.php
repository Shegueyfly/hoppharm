...
<?php
  function phpAlert($msg) {
    ...
    if(isset($_POST['submit'])) {
      ...
      $NOMHOPITAL  = 	addslashes($_POST['nom_hopital']);
      ...
      $DATEAJOUT	=	date('Y-m-d H:i:s');
            ...
            $sql = "INSERT INTO hopitaux (NOMHOPITAL, EMAIL, TEL, DESCRIPTION, LOCALISATION, WEBSITE, DATEAJOUT, GENDER) VALUES ('$NOMHOPITAL' , '$EMAIL', '$TEL', '$DESCRIPTION', '$LOCALISATION', '$WEBSITE', '$DATEAJOUT', '$GENDER')";
            $requete = mysqli_query($connect, $sql) or die( mysqli_error() ) ;
            echo '<SCRIPT LANGUAGE="JavaScript">document.location.href="add-hopital.php?mod=1" </SCRIPT>';
          }
            ?>
        ...
        <div class="block-header">
            ...
            <?php
								  if(isset($_GET['mod'])){
									  ...
									  {
									  ?>
									  <h4 style="color: #3CB371;">Lhopital a été enreistrer avec succès. </h4>
									  <?php
									   }
								  }
								   ?>
                           ...
                           <div class="row clearfix">
                               <div class="col-sm-6">
                                   <div class="form-group">
                                       <div class="form-line">
                                           <input type="text" name="nom_hopital" class="form-control" placeholder="Nom hopital" required autofocus>
                                       </div>
                                   </div>
                               </div>
                               <div class="col-sm-6">
                               ...
                               <div class="col-sm-3">
                                   <div class="form-group drop-custum">
                                       <select name="gender" class="form-control show-tick">
                                           ...
                                           <option value="Parapublic" required>Parapublic</option>
                                           <option value="Prive" required>Prive</option>
                                       </select>
                                   </div>
                               </div>
                               <div class="col-sm-3">
