...
<section class="content">
  ...
  <?php
    ...
    if(isset($_POST['SaveThis'])){
      ...
      $req="SELECT * FROM deltaweb_presentation";
      $query=mysqli_query($connect, $req);
      $rows=mysqli_num_rows($query);

      if($rows<1){

        $sql="INSERT INTO `hopharm_presentation`( `presentation`, `presentation1`, `presentation2`) VALUES ('".$description."','".$description1."','".$description2."')";
        $requete = mysqli_query($connect, $sql) or die( mysqli_error() ) ;

      } else{

        $sql="UPDATE `hopharm_presentation` SET `presentation`='".$description."',`presentation1`='".$description1."' ,`presentation2`='".$description2."' ";
        $requete = mysqli_query($connect, $sql) or die( mysqli_error() ) ;

      }

      echo '<SCRIPT LANGUAGE="JavaScript">document.location.href="presentation.php" </SCRIPT>';
    }
  ...
  <?php
    ...
    $req="select * from hopharm_presentation";
    $query=mysqli_query($connect, $req);
    while($enreg=mysqli_fetch_array($query)){
      $description	=	$enreg['presentation'];
      $description1	=	$enreg['presentation1'];
      $description2	=	$enreg['presentation2'];
    }
...
<form method="post">
    <div class="row">
     ...
     <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
         <b>Texte de présentation dans la page d'accueil</b>
       <div class="input-group">
                       <div class="form-line">
            <textarea name="description" id="description"  rows="8" cols="3"   class="form-control" required>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
         <b>Texte de présentation dans la page présentation</b>
       <div class="input-group">
                       <div class="form-line">
            <textarea name="description1" id="description1"  rows="8" cols="3"   class="form-control" required>
      ...
      <div class="form-actions">
        <input name="SaveThis" type="hidden">
