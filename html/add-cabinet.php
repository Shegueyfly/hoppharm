...
<?php
  function phpAlert($msg) {
    ...
    if(isset($_POST['submit'])) {
      ...
      $NOM  = 	addslashes($_POST['nom_medcin']);
      ...
      $DATEAJOUT	=	date('Y-m-d H:i:s');
            ...
            $sql = "INSERT INTO cabinet (NOM, ADRESSE, TEL, SPECIALITE, DATEAJOUT) VALUES ('$NOM' , '$ADRESSE', '$TEL', '$SPECIALITE', '$DATEAJOUT')";
            $requete = mysqli_query($connect, $sql) or die( mysqli_error() ) ;
            echo '<SCRIPT LANGUAGE="JavaScript">document.location.href="add-cabinet.php?mod=1" </SCRIPT>';
          }
            ?>
        ...
        <div class="block-header">
            ...
            <?php
								  if(isset($_GET['mod'])){
									  ...
									  {
									  ?>
									  <h4 style="color: #3CB371;">cabinet a été enreistrer avec succès. </h4>
									  <?php
									   }
								  }
								   ?>
              ...
              <form action="" method="POST" >
                           <div class="row clearfix">
                               <div class="col-sm-6">
                                   <div class="form-group">
                                       <div class="form-line">
                                           <input type="text" name="nom_medcin" class="form-control" placeholder="Nom medcin" required autofocus>
                                       </div>
                                   </div>
                               </div>
                               <div class="col-sm-6">
                           ...
                           <div class="row clearfix">
                               ...
                               <div class="col-sm-6">
                                   <div class="form-group">
                                       <div class="form-line">
                                           <input type="text" name="specialite"  class="form-control" placeholder="Specialite" required>
                                       </div>
                                   </div>
                               </div>
                             </div>
