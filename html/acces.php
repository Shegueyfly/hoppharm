...
<?php
  function phpAlert($msg) {
    ...
    if(isset($_POST['submit'])) {
      ...
      $NEW_MOTDEPASSE 		= 	addslashes($_POST["new_password"]);

      //if ($PASSWORD==$_SESSION['Password']) {

        echo $sql = "UPDATE utilisateur SET motdepasse ='$NEW_MOTDEPASSE' WHERE login ='$LOGIN' ";
        $requete = mysqli_query($connect, $sql) or die( mysqli_error() ) ;
        //echo '<SCRIPT LANGUAGE="JavaScript">document.location.href="acces.php?mod=1" </SCRIPT>';
      //}

          }

          //$_SESSION['Password'] = $NEW_MOTDEPASSE;
            ?>
        ...
        <div class="block-header">
            ...
            echo $_SESSION['password'];
								  if(isset($_GET['mod'])){
									  ...
									  ?>
									  <h4 style="color: #3CB371;">Mot de passe modifier. </h4>
									  <?php
									   }
								  }
								   ?>
              ...
              <form action="" method="POST">
                <div class="col-sm-6">
                    <div class="form-group">
                        <div class="form-line">
                            <input type="text" name="login" value="<?php echo $_SESSION['User'] ?>" class="form-control" placeholder="User Name" required>
                        </div>
                    </div>
                </div>
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    ...
                    <button type="submit" name="submit" class="btn btn-raised btn-success btn-sm">Save Changes</button>
              </form>
            </center>
            </div>
   				</div>
