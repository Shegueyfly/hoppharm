...
<?php
  function phpAlert($msg) {
    ...
    if(isset($_POST['submit'])) {
      ...
      $NOM  = 	addslashes($_POST['nom_medicament']);
      $DISPONIBILITE        = 	addslashes($_POST['disponibilite']);
      $UNITE 		= 	addslashes($_POST["unite"]) ;
      $TYPE      = 	addslashes($_POST["type_medicament"] );
      $PHARMACIE    =	addslashes($_POST['pharmacie']);
      $DATEAJOUT	=	date('Y-m-d H:i:s');



            $sql = "INSERT INTO medicament (NOM, DISPONIBLE, UNITE, TYPE, PHARMACIE, DATEAJOUT) VALUES ('$NOM' , '$DISPONIBILITE', '$UNITE', '$TYPE', '$PHARMACIE', '$DATEAJOUT')";
            $requete = mysqli_query($connect, $sql) or die( mysqli_error() ) ;
            //echo '<SCRIPT LANGUAGE="JavaScript">document.location.href="add-medicament.php?mod=1" </SCRIPT>';
          }
            ?>
        ...
        <div class="block-header">
            ...
            <?php
								  if(isset($_GET['mod'])){
									  ...
									  {
									  ?>
									  <h4 style="color: #3CB371;">Medicament a été enreistrer avec succès. </h4>
									  <?php
									   }
								  }
								   ?>
              ...
              <form action="" method="POST" >
                           <div class="row clearfix">
                               <div class="col-sm-6">
                                   <div class="form-group">
                                       <div class="form-line">
                                           <input type="text" name="nom_medicament" class="form-control" placeholder="Nom medicament" required>
                                       </div>
                                   </div>
                               </div>
                               <div class="col-sm-6">
                                   <div class="form-group">
                                     <select name="pharmacie" class="form-control show-tick">
                                         <option value="">-- Selectionnez une Pharmacie --</option>
                                         <?php
                                         $rec="select * from pharmacie";
                                         $query=mysqli_query($connect, $rec);
                                         while ($res=mysqli_fetch_array($query)) {?>
                                           <option value="<?php echo $res["id"]; ?>"><?php echo $res["NOMPHARMACIE"]; ?></option>
                                        <?php }
                                          ?>
                                     </select>
                                   </div>
                           ...
                           <div class="row clearfix">
                               <div class="col-sm-3">
                                   <div class="form-group">
                                       <div class="form-line">
                                           <input type="text" name="type_medicament" class="form-control" placeholder="Type medicament" required>
                                       </div>
                                   </div>
                               </div>
                               <div class="col-sm-3">
                                   <div class="form-group drop-custum">
                                       <select name="disponibilite" class="form-control show-tick">
                               ...
                               <div class="col-sm-3">
                                   <div class="form-group">
                                       <div class="form-line">
                                           <input type="number" name="unite"  class="form-control" placeholder="Unite" required>
                                       </div>
                                   </div>
                               </div>
                              <!--<div class="col-lg-12 col-md-12 col-sm-12">
